...
#ifndef LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_BUILDER_H
#define LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_BUILDER_H
...
#endif // LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_BUILDER_H
