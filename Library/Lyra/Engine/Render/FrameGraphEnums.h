...
#ifndef LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_ENUMS_H
#define LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_ENUMS_H
...
#endif // LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_ENUMS_H
