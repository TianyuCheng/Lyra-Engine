...
#ifndef LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_TRAITS_H
#define LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_TRAITS_H
...
#endif // LYRA_LIBRARY_ENGINE_RENDER_FRAME_GRAPH_TRAITS_H
