...
namespace lyra
{
    ...
    public:
        /**
         * @brief Constructs a LinearMemoryAllocator.
         *
         ...
         */
        explicit LinearMemoryAllocator(size_t page_size, std::pmr::memory_resource* upstream = std::pmr::get_default_resource());

        /**
         * @brief Destroys the LinearMemoryAllocator, freeing all allocated memory.
         */
        ...
        LinearMemoryAllocator& operator=(LinearMemoryAllocator&&) noexcept;
    ...
    template <typename T>
    LinearMemoryAllocator<T>::LinearMemoryAllocator(size_t page_size, std::pmr::memory_resource* upstream)
    ...
    template <typename T>
    LinearMemoryAllocator<T>::~LinearMemoryAllocator()
    {
        destroy();
    }

    template <typename T>
    LinearMemoryAllocator<T>::LinearMemoryAllocator(LinearMemoryAllocator&& other) noexcept
    ...
    template <typename T>
    LinearMemoryAllocator<T>& LinearMemoryAllocator<T>::operator=(LinearMemoryAllocator&& other) noexcept
    {
        if (this != &other) {
            destroy();
            _upstream           = other._upstream;
    ...
    template <typename T>
    T* LinearMemoryAllocator<T>::allocate()
    {
    ...
    template <typename T>
    void LinearMemoryAllocator<T>::reset()
    {
    ...
    template <typename T>
    void LinearMemoryAllocator<T>::destroy()
    {
    ...
    template <typename T>
    void LinearMemoryAllocator<T>::new_page()
    {
